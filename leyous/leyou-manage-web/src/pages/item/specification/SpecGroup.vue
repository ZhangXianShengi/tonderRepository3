<template>
  <div>
    <v-data-table
      ...
      <template slot="items" slot-scope="groups">
        <tr @click="selectGroup(groups.item)">
          <td class="text-xs-center">{{groups.item.id}}</td>
          <td class="text-xs-center">{{groups.item.name}}</td>
          <td class="justify-center layout px-0">
            <v-btn icon @click.stop="editGroup(this.groups.item)"><i class="el-icon-edit"/> </v-btn>
            <v-btn icon @click.stop="deleteGroup(this.groups.item.id)"><i class="el-icon-delete"/> </v-btn>
          </td>
        </tr>
      </template>
    </v-data-table>
